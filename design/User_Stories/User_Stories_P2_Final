# User Stories - Updated for P2 Milestone #
...
## **Stories Chosen**
These are the User Stories we are tackling for this milestone:

1. As a user, I can play plunder chess.
2. As a user, I need to register to the system or login.
4. As a user, I would like to start a match.

Note that we split these user stories over 2 Sprints, Sprint 2 and Sprint 3.
...
| Acceptance Criteria | - A username should be alphanumeric characters and contain no spaces <br /> - Users must have unique user names <br/> - Users must have a valid email address <br/> - A user password must be at alphanumeric or !@#$%^&*() characters <br/> - A user must submit an email, a password, and a username when creating an account. <br/> - When a user is logging in they must use the password they input for account creation.
