...
public class Knight extends ChessPiece {
    ...
    public ArrayList<String> legalMoves() {
        ...
        //loop thru the moveSet by adding the moveSet to the pieces position and make sure that it is a legal move.
        for (int[] m : moveSet) {
            char row = (char) ('1' + this.row + m[0]);
            char col = (char) ('a' + this.column + m[1]);

            String newPosition = col + "" + row;
            /*this loop determines if a position is legal, legality is assuring that the space is either null/empty
              or the space is occupied by an enemy piece.
            */
            try {
