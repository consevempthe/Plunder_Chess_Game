...
class KnightTest {
    ...
    void legalMoves() {
        ...
        assertEquals(3, k_w.legalMoves(true).size());
        assertTrue(k_w.legalMoves(true).contains("a3"));
        assertTrue(k_w.legalMoves(true).contains("c3"));
        assertTrue(k_w.legalMoves(true).contains("d2"));

        chess.placePiece(k_b, "b8");
        assertEquals(3, k_b.legalMoves(true).size());
        assertTrue(k_b.legalMoves(true).contains("a6"));
        assertTrue(k_b.legalMoves(true).contains("c6"));
        assertTrue(k_b.legalMoves(true).contains("d7"));

        chess.placePiece(k_w, "h1");
        assertEquals(2, k_w.legalMoves(true).size());
    }
    ...
    void noLegalMoves() {
        ...
        assertEquals(0, k_w.legalMoves(true).size());
    ...
    void legalCaptureMoves() {
        ...
        assertEquals(3, k_w.legalMoves(true).size());
        assertTrue(k_w.legalMoves(true).contains("f3"));
    }
}