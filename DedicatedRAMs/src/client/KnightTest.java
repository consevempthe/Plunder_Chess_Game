...
class KnightTest {
    ...
    void legalMoves() {
        ...
        assertEquals(3, k_w.legalMoves().size());
        assertTrue(k_w.legalMoves().contains("a3"));
        assertTrue(k_w.legalMoves().contains("c3"));
        assertTrue(k_w.legalMoves().contains("d2"));

        chess.placePiece(k_b, "b8");
        assertEquals(3, k_b.legalMoves().size());
        assertTrue(k_b.legalMoves().contains("a6"));
        assertTrue(k_b.legalMoves().contains("c6"));
        assertTrue(k_b.legalMoves().contains("d7"));

        chess.placePiece(k_w, "h1");
        assertEquals(2, k_w.legalMoves().size());
    }
    ...
    void noLegalMoves() {
        ...
        assertEquals(0, k_w.legalMoves().size());
    ...
    void legalCaptureMoves() {
        ...
        assertEquals(3, k_w.legalMoves().size());
        assertTrue(k_w.legalMoves().contains("f3"));
    }
}